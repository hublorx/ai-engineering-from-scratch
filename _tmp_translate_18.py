"""Translate lesson 18 Convex Optimization EN->PL"""
import sys
sys.path.insert(0, 'C:/VisualStudioCodeRepo/AIWorkspace')
from execution.minimax_utils import get_client, call_minimax

lesson_slug = "18-convex-optimization"
source_file = "C:/VisualStudioCodeRepo/AIWorkspace/ai-engineering-from-scratch/phases/01-math-foundations/18-convex-optimization/docs/en.md"
