#!/usr/bin/env python3
"""Translate lesson 09 using MiniMax."""
import sys
...
Tlumacz sekcje markdown: ## Learning Objectives -> ## Cele uczenia się, ## The Problem -> ## Problem, ## The Concept -> ## Koncepcja, ## Prerequisites -> ## Wymagania wstępne, ## Time -> ## Czas, ## Summary -> ## Podsumowanie
...
client = get_client()
result = call_minimax(client, TRANSLATE_SYSTEM, "Tlumacz nastepujacy tekst na jezyk polski:\n\n" + SOURCE)
if result:
    print(result)
else:
