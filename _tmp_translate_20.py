"""Translate lesson 20 Fourier Transform EN->PL"""
import sys
sys.path.insert(0, 'C:/VisualStudioCodeRepo/AIWorkspace')
from execution.minimax_utils import get_client, call_minimax

lesson_slug = "20-fourier-transform"
source_file = "C:/VisualStudioCodeRepo/AIWorkspace/ai-engineering-from-scratch/phases/01-math-foundations/20-fourier-transform/docs/en.md"
