"""Translate lesson 16 Sampling Methods EN->PL"""
import sys
sys.path.insert(0, 'C:/VisualStudioCodeRepo/AIWorkspace')
from execution.minimax_utils import get_client, call_minimax

lesson_slug = "16-sampling-methods"
source_file = "C:/VisualStudioCodeRepo/AIWorkspace/ai-engineering-from-scratch/phases/01-math-foundations/16-sampling-methods/docs/en.md"
