"""Translate lesson 21 Graph Theory EN->PL"""
import sys
sys.path.insert(0, 'C:/VisualStudioCodeRepo/AIWorkspace')
from execution.minimax_utils import get_client, call_minimax

lesson_slug = "21-graph-theory"
source_file = "C:/VisualStudioCodeRepo/AIWorkspace/ai-engineering-from-scratch/phases/01-math-foundations/21-graph-theory/docs/en.md"
